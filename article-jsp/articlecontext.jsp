...
<html>
				...
				<div class="container">
					...
					<div id="nav">
						<nav id="nav">
							<ul>
									<li ><a href="#">首頁</a></li>
									<li class="active"><a href="專欄主頁面.html">專欄主頁</a></li>
					...
					<!-- Sidebar -->
						<div id="sidebar" class="4u">
							<section>
								<header>
									<h3>作者</h2>
									<h2><a href="https://www.commonhealth.com.tw/" >康健雜誌</a></h2>
									<span class="byline">
											<p>
								...
								<p><a href="https://www.commonhealth.com.tw/" >關於康健雜誌</a></p>
								<ul class="default">
										<div class="like" data-post-id="">
												<a href="#" class="button" style="width:60px; height:40px; border:2px blue; background-color:pink;">&#10084</a><br>
																   <span class="article-favorites">
											...
											<!-- Sharingbutton Facebook -->
 											...
 											<!-- Sharingbutton Twitter -->
  											...
  											<!-- Sharingbutton Google+ -->
													<a class="resp-sharing-button__link" href="https://plus.google.com/share?url=http%3A%2F%2Fsharingbuttons.io" target="_blank" rel="noopener" aria-label="Google+">
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								<header>
									...
									<span class="byline" ><em>${articlecontext.subtitle}</em></span>
								</header>
								<p><a href="#" class="image full"><img src="${pageContext.servletContext.contextPath}/article/getImage?id=${articlecontext.articleId}" alt="" width="80px" height="350px" ></a></p>
								<p>${context}
								</p>
							</section>
						</div>
	...
	<div id="copyright">
			<div class="container">
					Contact information: contact@fititude.com <br>
